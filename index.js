...
// Dota 2 taunts - 200 - 249 where 2 stands for 2 from dota 2
...
// Dota Underlords taunts - 250 - 299 where 2 stands for 2 from dota 2
registerTaunt(250, [{file: './taunts/dac/yo/yo_01.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_02.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_03.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_04.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_05.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_06.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_07.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_08.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_09.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_10.mp3',                                 text: 'Yo!'},
                    {file: './taunts/dac/yo/yo_11.mp3',                                 text: 'Yo!'}], ['dota', 'dac', 'yo']);
registerTaunt(251, [{file: './taunts/dac/ow/ow_01.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_02.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_03.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_04.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_05.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_06.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_07.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_08.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_09.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_10.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_11.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_12.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_13.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_14.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_15.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_16.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_17.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_18.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_19.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_20.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_21.mp3',                                 text: 'Ow!'},
                    {file: './taunts/dac/ow/ow_22.mp3',                                 text: 'Ow!'}], ['dota', 'dac', 'ow']);
registerTaunt(252, [{file: './taunts/dac/oi/oi_01.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_02.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_03.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_04.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_05.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_06.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_07.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_08.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_09.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_10.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_11.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_12.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_13.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_14.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_15.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_16.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_17.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_18.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_19.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_20.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_21.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_22.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_23.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_24.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_25.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_26.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_27.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_28.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_29.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_30.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_31.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_32.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_33.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_34.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_35.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_36.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_37.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_38.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_39.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_40.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_41.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_42.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_43.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_44.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_45.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_46.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_47.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_48.mp3',                                 text: 'Oi!'},
                    {file: './taunts/dac/oi/oi_49.mp3',                                 text: 'Oi!'}], ['dota', 'dac', 'oi']);
registerTaunt(253, [{file: './taunts/dac/hot/hot_01.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_02.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_03.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_04.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_05.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_06.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_07.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_08.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_09.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_10.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_11.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_12.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_13.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_14.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_15.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_16.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_17.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_18.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_19.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_20.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_21.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_22.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_23.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_24.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_25.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_26.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_27.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_28.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_29.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_30.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_31.mp3',                               text: 'Hot!'},
                    {file: './taunts/dac/hot/hot_32.mp3',                               text: 'Hot!'}], ['dota', 'dac', 'hot']);
...
client.on('message', async message => {
    ...
    */
    ...
    if (message.content.startsWith(process.env.PLAYER_PREFIX))
    {
        const command = message.content.substr(process.env.PLAYER_PREFIX.length).split(' ')[0];
...
**Now playing:** ${serverQueue.songs[0].title}
		`);
            ...
            return message.channel.send('There is nothing playing.');
        } else if (command === 'disconnect' || command === 'dc' || command === 'leave') {
            const voiceChannel = message.member.voiceChannel;
            if (!voiceChannel) {
                return message.channel.send('You need to join a voice channel first!');
            }
    ...
    if (message.content.startsWith(process.env.PREFIX)) {
        ...
        if (command === 'help') {
            return message.channel.send(`You type "${process.env.PREFIX} TOPIC" and I will try to write a small essay about given topic.`);
        }
